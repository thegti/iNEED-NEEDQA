...
enquirySubmit(): void {
  ...
  this.enquiryService.SaveEnquiry(this.enquiryRequest).subscribe((data: Array<object>) => {
      if (data['Data'] > 0) {
          ...
          var msg='Thank you for submitting your requirment.Ref.No[' + data['Data'] + ']. You will be contacted soon, a copy of your requirment is shared in your txtEmail.';
          console.log(msg);
          this.confirmDialogRef.componentInstance.Message = 'Thank you for submitting your requirment.Ref.No[' + data['Data'] +']. You will be contacted soon, a copy of your requirment is shared in your txtEmail.';
